...
;************************************************************************************************
[SEGMENT .data]
    strWelcomeMsg   db  "Welcome to the ||noobOS _/o o\_|| Enter 'help' to dispaly menu", 0x00
	strPrompt		db	"Command>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"||noobOS _/o o\_||", 0x00	;OS details
	strMajorVer		db	"0", 0x00
	strMinorVer		db	".04", 0x00
	strTest			db	"Modified by Thakshila Bandara", 0x00
	...
	strHelp1		db	"ver     - display the JOSH version", 0x00
	strHelp2		db	"exit    - reboot", 0x00
	strHelp3		db	"hwinfo   - Display hardware information", 0x00
	strHelp4		db	"credit     - Developer details who update the JOSH to current version", 0x00

	cmdVer			db	"ver", 0x00		; internal commands
	cmdExit			db	"exit", 0x00
	cmdWho			db	"credit", 0x00		;test command
